 ...
 <h1>Privacy Policy</h1>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li><strong>Vehicle Information:</strong> Rental details, vehicle usage, and location data (if GPS is enabled in our vehicles).</li>
            <li><strong>Other Data:</strong> Communication records, feedback, or inquiries you make with us.</li>
        </ul>
    </div>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li>Verify your identity and eligibility for car rental services.</li>
            <li>Process payments and provide receipts.</li>
            <li>Provide customer support and respond to inquiries.</li>
            <li>Improve our services, including vehicle maintenance and updates.</li>
            <li>Send promotional materials or service updates (with your consent).</li>
            <li>Ensure compliance with legal obligations and enforce our rental agreement.</li>
        </ul>
    </div>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li><strong>Legal Obligations:</strong> To comply with applicable laws, regulations, or court orders.</li>
            <li><strong>Business Transfers:</strong> In the event of a merger, acquisition, or sale of assets.</li>
            <li><strong>Authorized Parties:</strong> If you provide explicit consent to share your information.</li>
        </ul>
    </div>
    ...
    <div class="section">
        ...
        <p>To exercise these rights, please contact us at <a href="mailto:[Insert Contact Email]">marcialmotors@test.com</a>.</p>
    </div>
